...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.AP_LOTE_HISTORICO/" %}
...
SELECT
  ...
  , r.ds_titulo
    ...
    -- Timestamp (DT_* -> dh_*)
  , CAST(r.dt_historico AS TIMESTAMP)         AS dh_historico
