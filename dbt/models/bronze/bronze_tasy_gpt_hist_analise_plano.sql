...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.GPT_HIST_ANALISE_PLANO/" %}
...
SELECT
  ...
  , r.ds_observacao
    ...
    -- Timestamps (DT_* -> dh_*)
  , CAST(r.dt_analise AS TIMESTAMP)             AS dh_analise
