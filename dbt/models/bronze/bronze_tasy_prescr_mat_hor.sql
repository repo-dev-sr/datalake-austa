...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.PRESCR_MAT_HOR/" %}
...
SELECT
  ...
  , CAST(r.dt_preparo AS TIMESTAMP)             AS dh_preparo
  , CAST(r.dt_administracao AS TIMESTAMP)       AS dh_administracao
