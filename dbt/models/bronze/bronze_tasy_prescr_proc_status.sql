...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.PRESCR_PROC_STATUS/" %}
...
SELECT
  ...
  , r.ie_tipo_evento
    ...
    -- Timestamp do status (DT_* -> dh_*)
  , CAST(r.dt_evento AS TIMESTAMP)              AS dh_evento
  , CAST(r.dt_status AS TIMESTAMP)              AS dh_status
