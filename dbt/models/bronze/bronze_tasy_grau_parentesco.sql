...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/austa.TASY.GRAU_PARENTESCO/" %}
...
SELECT
  ...
  , r.nm_usuario_nrec
  , r.ie_tipo_parentesco
  , r.cd_sib
  , r.ie_grau_parentesco
  , r.cd_ptu
  , r.cd_sistema_anterior
  , r.cd_parentesco_mx
