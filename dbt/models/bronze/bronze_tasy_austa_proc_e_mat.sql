...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/austa.TASY.AUSTA_PROC_E_MAT/" %}
...
SELECT
  ...
  , r.cd_item
  , r.ds_item
  , r.ds_classificacao_1
  , r.ds_classificacao_2
  , r.ds_classificacao_3
