...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.MED_AVALIACAO_PACIENTE/" %}
...
SELECT
  ...
  , r.cd_pessoa_fisica
  , r.cd_profissional
  , r.nr_seq_tipo_avaliacao
  , r.nr_seq_resultado
  , r.nr_seq_intervencao

    -- Atributos da avaliacao
  , r.ie_tipo_avaliacao
  , r.ie_status
  , r.ie_resultado
  , r.ds_avaliacao
  ...
  , r.ds_conduta
    ...
    -- Timestamps (DT_* -> dh_*)
  , CAST(r.dt_avaliacao AS TIMESTAMP)           AS dh_avaliacao
