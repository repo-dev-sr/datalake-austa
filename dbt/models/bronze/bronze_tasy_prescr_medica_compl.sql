...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.PRESCR_MEDICA_COMPL/" %}
...
SELECT
  ...
  , r.ds_titulo
    ...
    -- Timestamps (DT_* -> dh_*)
  , CAST(r.dt_complemento AS TIMESTAMP)         AS dh_complemento
