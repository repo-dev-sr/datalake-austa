...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/austa.TASY.AUSTA_TMP_FARM_VIAADM/" %}
...
SELECT
  ...
  , r.cd_via_aplicacao
    ...
    -- Atributos de via de administracao (AUSTA)
  , r.ds_via_adm
  , r.ds_observacao
  , r.ie_situacao
