...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.FA_RECEITA_FARMACIA/" %}
...
SELECT
  ...
  , r.ie_controlada
    ...
    -- Timestamps (DT_* -> dh_*)
  , CAST(r.dt_receita AS TIMESTAMP)             AS dh_receita
