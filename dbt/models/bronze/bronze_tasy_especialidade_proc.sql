...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/austa.TASY.ESPECIALIDADE_PROC/" %}
...
SELECT
  ...
  , r.nm_usuario
  , r.cd_area_procedimento
  , r.cd_especialidade_medica
  , r.ie_origem_proced
  , r.cd_original
  , r.dt_atualizacao_nrec as dh_atualizacao_nrec
  , r.nm_usuario_nrec
  , r.cd_sistema_ant
  , r.cd_especialidade_loc
