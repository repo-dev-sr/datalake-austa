...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.PRESCR_PROC_ETAPA/" %}
...
SELECT
  ...
  , r.ds_etapa
    ...
    -- Timestamps da etapa (DT_* -> dh_*)
  , CAST(r.dt_etapa AS TIMESTAMP)               AS dh_etapa
  , CAST(r.dt_inicio_etapa AS TIMESTAMP)        AS dh_inicio_etapa
  , CAST(r.dt_fim_etapa AS TIMESTAMP)           AS dh_fim_etapa
