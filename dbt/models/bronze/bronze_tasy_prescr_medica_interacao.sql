...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.PRESCR_MEDICA_INTERACAO/" %}
...
SELECT
  ...
  , r.cd_material2
    ...
    -- Atributos da interacao medicamentosa
  , r.ie_tipo_interacao
  , r.ie_severidade
  , r.ds_interacao
  , r.ds_mecanismo
  , r.ds_conduta
    ...
    -- Timestamps (DT_* -> dh_*)
  , CAST(r.dt_interacao AS TIMESTAMP)           AS dh_interacao
