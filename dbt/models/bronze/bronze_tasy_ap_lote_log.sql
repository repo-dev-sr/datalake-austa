...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/tasy.TASY.AP_LOTE_LOG/" %}
...
SELECT
  ...
  , r.ds_observacao
    ...
    -- Timestamp do evento (DT_* -> dh_*)
  , CAST(r.dt_log AS TIMESTAMP)               AS dh_log
