...
{% set raw_path = "s3a://austa-lakehouse-prod-data-lake-169446931765/raw/raw-tasy/stream/austa.TASY.AUSTA_PRESTADOR/" %}
...
SELECT
  ...
  , r.ds_municipio
  , r.ds_estado
  , r.dt_inclusao as dh_inclusao
  , r.dt_exclusao as dh_exclusao
  , r.ds_tipo
  , r.ds_classificacao
