"""Bronze TASY ATENDIMENTO_PACIENTE — Avro → Iceberg."""
...
from embedded.bronze.atendimento_paciente import PIPELINE_SQL  # noqa: E402
from pyspark.sql import DataFrame, SparkSession  # noqa: E402

RAW_AVRO_PATH = (
    f"s3a://{DATALAKE_BUCKET}/raw/raw-tasy/stream/tasy.TASY.ATENDIMENTO_PACIENTE/"
)
TARGET_TABLE = fq_table("bronze", "bronze_tasy_atendimento_paciente")
...
def main() -> None:
    spark = create_spark_session("bronze_tasy_atendimento_paciente")
    run_bronze_append(
        spark,
