"""Bronze TASY CONTA_PACIENTE — Avro → Iceberg."""
...
from embedded.bronze.conta_paciente import PIPELINE_SQL  # noqa: E402
from pyspark.sql import DataFrame, SparkSession  # noqa: E402

RAW_AVRO_PATH = f"s3a://{DATALAKE_BUCKET}/raw/raw-tasy/stream/tasy.TASY.CONTA_PACIENTE/"
TARGET_TABLE = fq_table("bronze", "bronze_tasy_conta_paciente")
...
def main() -> None:
    spark = create_spark_session("bronze_tasy_conta_paciente")
    run_bronze_append(
        spark,
