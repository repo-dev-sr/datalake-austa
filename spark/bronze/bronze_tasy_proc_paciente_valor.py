"""Bronze TASY PROC_PACIENTE_VALOR — Avro → Iceberg."""
...
from embedded.bronze.proc_paciente_valor import PIPELINE_SQL  # noqa: E402
from pyspark.sql import DataFrame, SparkSession  # noqa: E402

RAW_AVRO_PATH = f"s3a://{DATALAKE_BUCKET}/raw/raw-tasy/stream/tasy.TASY.PROC_PACIENTE_VALOR/"
TARGET_TABLE = fq_table("bronze", "bronze_tasy_proc_paciente_valor")
...
def main() -> None:
    spark = create_spark_session("bronze_tasy_proc_paciente_valor")
    run_bronze_append(
        spark,
