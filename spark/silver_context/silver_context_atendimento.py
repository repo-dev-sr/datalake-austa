"""Silver-Context atendimento — overwrite Iceberg."""
...
from embedded.silver_context.atendimento import PIPELINE_SQL  # noqa: E402

TARGET = fq_table("silver_context", "atendimento")


def main() -> None:
    spark = create_spark_session("silver_context_atendimento")
