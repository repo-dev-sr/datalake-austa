"""Silver TASY conta_paciente — pipeline embutido."""
...
from embedded.silver.conta_paciente import PIPELINE_SQL  # noqa: E402

BRONZE_TABLE = fq_table("bronze", "bronze_tasy_conta_paciente")
SILVER_TABLE = fq_table("silver", "silver_tasy_conta_paciente")


def main() -> None:
    spark = create_spark_session("silver_tasy_conta_paciente")
