...
from embedded.gold.dim_cid import PIPELINE_SQL  # noqa: E402


def main() -> None:
    spark = create_spark_session("gold_dim_cid")
    run_gold_overwrite_sql(spark, pipeline_sql=PIPELINE_SQL, target_fq=fq_table("gold", "dim_cid"))
    spark.stop()
